...
class App extends Component {
  ...
  constructor() {
    ...
    .then(function(response, data) {
            ...
            self.setState({duration: Math.round(t1 - t0, 0)})
        })
    }
      ...
      <div className="App">
        ...
        <div className="App-upload">
          ...
          { this.state.imagePrediction &&
            <div><p>The model predicted: {this.state.imagePrediction}
            </p>
            <p>The time it took to predict the image: {this.state.duration}ms</p></div>
          }
          </div>
          </div>
        </header>
